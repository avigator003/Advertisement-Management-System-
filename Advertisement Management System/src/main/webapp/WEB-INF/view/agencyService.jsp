...
<body>
    ...
    <section class="hero-section set-bg" data-setbg="/img/hero-bg.jpg">
      <div class="btn btn-primary" style=" position:relative;top:-20px;left:600px;height: 50px;width: 200px"><a href="<%=path%>/akshat/register" style="color:black;font-size: 30px;border-radius: 10px">REGISTER</a></div>
      <hr>
    <div class="btn btn-primary" style=" position:relative;top:100px;left:600px;height: 50px;width: 200px"><a href="<%=path%>/akshat/login" style="color:black;font-size: 30px;border-radius: 10px">LOGIN</a></div>
