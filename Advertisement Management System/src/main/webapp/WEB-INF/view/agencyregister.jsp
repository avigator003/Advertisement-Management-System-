	...
	<div class="main-w3layouts wrapper">
		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="<%=path%>/akshat/registersave" method="post">
				    <input class="text" type="text" name="agencyName" placeholder="Agency Name" required="">
					<input class="text email" type="email" name="email" placeholder="Email" required="">
					<input class="text" type="text" name="mobileNumber" placeholder="Mobile No." required="">
